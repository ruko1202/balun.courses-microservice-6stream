...
- **Точка входа в систему - API Gatawey**
  - взаимодейсвтие клиентов с API Gatawey - REST
  - API Gatawey взаимодействует с внутренними сервисами по gRPC
  - Внутреннее взаимодействие между сервисами по gRPC или асинхронно
